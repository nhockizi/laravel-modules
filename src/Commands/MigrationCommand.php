...
namespace Kizi\Modules\Commands;

use Illuminate\Support\Str;
use Kizi\Modules\Support\Migrations\NameParser;
use Kizi\Modules\Support\Migrations\SchemaParser;
use Kizi\Modules\Support\Stub;
use Kizi\Modules\Traits\ModuleCommandTrait;
